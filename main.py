...
app = Flask(__name__)
data = pd.read_csv('/Users/heetmistry/Desktop/HPP2/template/final_dataset.csv')
pipe = pickle.load(open('/Users/heetmistry/Desktop/HPP2/template/RidgeModel.pkl',"rb"))
...
def index():
    ...
    return render_template('/Users/heetmistry/Desktop/HPP2/template/index.html', bedrooms=bedrooms, bathrooms=bathrooms, sizes=sizes, zip_codes=zip_codes)
...
app = Flask(__name__)
data = pd.read_csv('/Users/heetmistry/Desktop/HPP2/template/final_dataset.csv', delimiter=',')
pipe = pickle.load(open('/Users/heetmistry/Desktop/HPP2/template/RidgeModel.pkl', "rb"))
